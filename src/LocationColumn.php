...
class LocationColumn extends \yii\grid\Column
{
    ...
    public $addressReturnfunction = 'completeAddress';
    /**
    ...
    {       
        return $model->{$this->addressReturnfunction};
    }
}
